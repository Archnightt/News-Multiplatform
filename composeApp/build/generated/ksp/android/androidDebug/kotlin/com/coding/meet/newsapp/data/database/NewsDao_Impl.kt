...
public class NewsDao_Impl(
  ...
  public override fun getArticles(): Flow<List<Article>> {
    ...
    return createFlow(__db, false, arrayOf("articleTable")) { _connection ->
      ...
      try {
        val _cursorIndexOfAuthor: Int = getColumnIndexOrThrow(_stmt, "author")
        ...
        val _cursorIndexOfPublishedAt: Int = getColumnIndexOrThrow(_stmt, "articleId")
        ...
        val _cursorIndexOfUrlToImage: Int = getColumnIndexOrThrow(_stmt, "urlToImage")
        val _result: MutableList<Article> = mutableListOf()
        while (_stmt.step()) {
          val _item: Article
          val _tmpAuthor: String?
          if (_stmt.isNull(_cursorIndexOfAuthor)) {
            _tmpAuthor = null
          } else {
            _tmpAuthor = _stmt.getText(_cursorIndexOfAuthor)
          }
          ...
          _tmpPublishedAt = _stmt.getText(_cursorIndexOfPublishedAt)
          val _tmpSource: Source
          val _tmp: String
          _tmp = _stmt.getText(_cursorIndexOfSource)
          ...
          if (_stmt.isNull(_cursorIndexOfUrlToImage)) {
            _tmpUrlToImage = null
          } else {
            _tmpUrlToImage = _stmt.getText(_cursorIndexOfUrlToImage)
          }
          _item =
