...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>kermit</b> with <b>co.touchlab:kermit</b> coordinates and
     * with version reference <b>kermit</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxDataStoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.data.store</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.data.store.core");
        }
    ...
    public static class ScreenLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>size</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kermit</b> with value <b>2.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>size</b> with value <b>0.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSize() { return getVersion("size"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxDataVersionAccessors vaccForAndroidxDataVersionAccessors = new AndroidxDataVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>androidx.room</b> with value <b>2.7.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.androidx.data</b>
         */
        public AndroidxDataVersionAccessors getData() {
            return vaccForAndroidxDataVersionAccessors;
        }
    ...
    public static class AndroidxDataVersionAccessors extends VersionFactory  {

        public AndroidxDataVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.data.store</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStore() { return getVersion("androidx.data.store"); }
